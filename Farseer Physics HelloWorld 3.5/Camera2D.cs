...
namespace PhaseShift.Utility
{
    public class Camera2D
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            _currentPosition = _targetPosition + new Vector2(-100f, -100f); //+= 100f * delta * inertia;// *(float)gameTime.ElapsedGameTime.TotalSeconds;
            _currentRotation = _targetRotation; //+= 80f * rotDelta * rotInertia;// *(float)gameTime.ElapsedGameTime.TotalSeconds;
